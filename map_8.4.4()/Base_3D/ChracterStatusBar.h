...
public:
	...
	void GetMonsterHP(float& hp, float maxHP) {if(monsterHealthBar) monsterHealthBar->Gauge_Width(hp, maxHP); };

	void SetShowMonsterHp(bool show) { bShowMonsterHp = show; }
};
