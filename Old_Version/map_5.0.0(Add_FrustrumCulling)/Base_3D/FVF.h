...
struct FVF_PositionNormalColorTexture
{
	D3DXVECTOR3 pos = D3DXVECTOR3(0, 0, 0);
	D3DXVECTOR3 normal = D3DXVECTOR3(0, 0, 0);
	D3DCOLOR color = D3DCOLOR_XRGB(0, 0, 0);
	...
	FVF_PositionNormalColorTexture( )
	{
	}
	FVF_PositionNormalColorTexture(D3DXVECTOR3 _pos, D3DXVECTOR3 _normal, D3DCOLOR _color, D3DXVECTOR2 _tex)
		: pos(_pos), normal(_normal), color(_color), tex(_tex)
	{
	}
