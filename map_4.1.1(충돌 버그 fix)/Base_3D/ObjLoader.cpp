...
void ObjLoader::LoadObjFileData(std::vector<ObjFileGroup*>& group, const char* fileName, OUT std::vector<D3DXVECTOR3>& positionList, bool isblend)
{
	...
	if ( fp != nullptr )
	{
		...
		positionList = pos; //경계상자의 MIN, MAX 설정에 사용하기 위해.
