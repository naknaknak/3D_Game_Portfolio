...
public:
	...
	void Initialize(std::vector<D3DXVECTOR3>& vertexList, D3DXMATRIXA16* trans = nullptr, D3DXMATRIXA16* rot = nullptr);
	void MinMaxVertices(std::vector<D3DXVECTOR3>& vertexList, const D3DXMATRIXA16 * matRot = nullptr);
	void Destroy();
	void Update();
	void Render();
