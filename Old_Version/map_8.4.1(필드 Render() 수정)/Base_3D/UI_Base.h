...
public:
	...
	inline void SetPosition_Center(float x, float y, float z)
	{
		int width_center = (int)(size.x * 0.5f);
		int Height_center = (int)(size.y * 0.5f);

		position = D3DXVECTOR3(x - width_center, y - Height_center, z);
	}
