...
void Collider_Sphere::Initialize(std::vector<D3DXVECTOR3> & vertexList, D3DXMATRIXA16* trans /*= nullptr*/, D3DXMATRIXA16* rot /*= nullptr*/)
{
	MinMaxVertices(vertexList, rot != nullptr ? rot : nullptr);
