...
public:
	...
	AseFrame* Load(const char* szFilename);
	std::map<int, std::vector<D3DXVECTOR3>> GetMapVertices( ) { return mapVertexList; }
private:
	...
	//
	std::map<int, std::vector<D3DXVECTOR3>> mapVertexList;
	int count_num = 0;
	//
